...
macro(Ubpa_AddDepPro projectName name version)
	...
	if("${_need_find}" STREQUAL TRUE)
		...
		if(${${name}_FOUND})
			...
			message(STATUS "searching _deps for ${name} v${version}")
			if(NOT EXISTS "${CMAKE_SOURCE_DIR}/_deps/${name}-${version}/CMakeLists.txt")
				message(FATAL_ERROR "${name} v${version} not found in ${CMAKE_SOURCE_DIR}/_deps")
			endif()
	...
	if(NOT UCMake_FOUND)
		message(STATUS \"searching _deps for UCMake v${UCMake_VERSION}\")
			if(NOT EXISTS \"${PROJECT_SOURCE_DIR}/_deps/UCMake-${UCMake_VERSION}/CMakeLists.txt\")
				message(FATAL_ERROR \"UCMake v${UCMake_VERSION} not found in _deps\")
			endif()
			FetchContent_Declare(
			  UCMake
